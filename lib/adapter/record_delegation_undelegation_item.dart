...
class RecordDelegationUndelegationItem extends StatefulWidget {
  RecordDelegationModel model;

  RecordDelegationUndelegationItem({this.model});

  @override
  _RecordDelegationUndelegationItemState createState() => _RecordDelegationUndelegationItemState();
}

class _RecordDelegationUndelegationItemState extends State<RecordDelegationUndelegationItem> {
  @override
...
//                child: FixedSizeText(widget.model.typeLabel, style: TextStyle(color: Color(AppColors.BLACK), fontSize: 16.0, fontWeight: FontWeight.bold),),
//              ),
              Expanded(
                child: Column(
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              FixedSizeText(
                                widget.model.typeLabel,
                                textAlign: TextAlign.center,
                                style: TextStyle(color: Color(AppColors.GREY_2), fontSize: 12.0),
                              ),
                              SizedBox(
                                height: 12.0,
                              ),
                          ...
                          Column(
                            ...
                            children: [
                              FixedSizeText(
                                FlutterI18n.translate(context, "delegation.reward_amount"),
                                textAlign: TextAlign.center,
                                style: TextStyle(color: Color(AppColors.GREY_2), fontSize: 12.0),
                              ),
                              SizedBox(
                              ...
                              FixedSizeText('${widget.model.rewardAmount}', style: TextStyle(color: Color(AppColors.BLACK), fontSize: 12.0, fontWeight: FontWeight.bold),),
                            ],
                          ),
